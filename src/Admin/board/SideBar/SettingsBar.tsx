                ...
                <div className={`fixed flex-shrink-0 w-64 overflow-y-auto bg-background-light dark:bg-background-dark border-indigo-100 border-r-2 shadow-lg  lg:static py-5 px-1 mt-[64px] h-[calc(100vh-64px)] right-0 rounded-tl-3xl rounded-bl-3xl z-50`}>
                    <ul className="font-medium px-2">
                        <li className="flex items-center gap-2  bg-transparent hover:bg-transparent " id="avatarButton " >
                            ...
                            <div id="Profile Info">
                                <h6 className='text-left text-text dark:text-text-dark' >Jese Leos</h6>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Web Developer</p>
                                <p className="text-sm text-gray-500 dark:text-gray-400 ">name@flowbite.com</p>
                            </div>
                        </li>

                        <hr className="border-gray-300 my-2" />

                        <label className=' shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-background-light dark:bg-gray-500'>
                            <input
                                type='checkbox'
                                className='sr-only'
                                checked={isDarkMode}
                            ...
                            />
                            <span
                                className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${!isDarkMode ? 'text-primary bg-[#f4f7ff]' : 'text-body-color'
                                    }`}
                            >
                                <svg
                                    width='16'
                            ...
                            <span
                                className={`flex items-center space-x-[6px] rounded py-2 px-[18px] text-sm font-medium ${isDarkMode ? 'text-primary bg-black' : 'text-body-color'
                                    }`}
                            >
                                <svg
                                    width='16'
                        ...
                        <div className="my-4" ref={modalRef}>
                            <button className="flex items-center gap-2 m-0 p-0 bg-transparent hover:bg-transparent" typeof="button" onClick={() => handleToggleDropdown('isOpenLanguage')}>
                                ...
                                <p className='text-left text-text-light dark:text-text-dark' >{languages == 'Eng' ? "Eng" : "Ind"}</p>
                        ...
                        <li>
                            <div className="py-1">
                                <h6 className="underline text-text-light dark:text-text-dark">Log Out</h6>
                            </div>
                        </li>
